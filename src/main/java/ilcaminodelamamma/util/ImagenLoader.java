...
public class ImagenLoader {
    ...
    public void cargarImagenesEjemplo() {
        ...
        cargarImagenReceta("/img/carne/Pollo-empanado-air-fryer.jpg", 37);
        cargarImagenReceta("/img/carne/churrasco.jpg", 38);
        cargarImagenReceta("/img/carne/estofado-ternera.jpg", 39);
        cargarImagenReceta("/img/carne/chuleta.jpg", 40);
        cargarImagenReceta("/img/carne/albondigas.jpg", 41);
        cargarImagenReceta("/img/carne/cordero-asado.jpg", 42);
        cargarImagenReceta("/img/carne/lasana-de-carne-con-verduras.jpg", 43);
        cargarImagenReceta("/img/carne/costillas-bbq.jpg", 44);
        cargarImagenReceta("/img/carne/churrasco.jpg", 45);
